---
description: Adicionar ou alterar um meio de pagamento
argument-hint: <tipo ou instancia>
---

Tarefa: $ARGUMENTS

Siga `docs/08-fluxos/novo-meio-de-pagamento.md`.
...
não existe e não deve ser deduzido.
