...
| **Diário** | A tela que responde *"o que aconteceu neste dia"*: os eventos de um dia do ambiente ativo, separando o que o sistema fez sozinho do que a pessoa fez. Um dia por vez, com seletor que anda para trás; para frente do dia corrente não há Diário. | `02-dominio/evento` |
| **Evento** | Uma linha que registra *o que aconteceu, quando e por quem* num ambiente. Entidade, não consulta — metade do que ele mostra (quando o previsto realizou, quando a fatura fechou) não é derivável do estado. Imutável, sem prazo de validade, e é ele que cumpre o "sempre com histórico" da correção de lançamento. | `02-dominio/evento` |
