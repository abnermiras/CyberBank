...
Em um ambiente compartilhado, usuários com permissão `Controle total` podem
criar e alterar categorias.

Categorias de uso sistêmico servem para ser de uso exclusivo do sistema para que ele possa 
criar uma transação de entrada ou saída sem precisar associar a uma categoria criada pelo usuário.
